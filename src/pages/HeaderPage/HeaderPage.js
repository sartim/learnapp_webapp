             ...
             <div className="nav-wrapper">
               ...
               <ul className="right hide-on-med-and-down">
                 <li>
                  ...
                  <ul id="notifications-dropdown" className="dropdown-content dropdown-content-header-override">
                    <li>
                      <h6>NOTIFICATIONS
                 ...
                 <li>
                   ...
                   <ul id="profile-dropdown" className="dropdown-content dropdown-content-header-override">
                     <li>
